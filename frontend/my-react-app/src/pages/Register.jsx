...
const validate = ({ name, email, password, confirmPassword }) => {
  const e = {};
  if (!name || name.trim().length < 2)   e.name    = "Full name is required";
  ...
  return (
    <div style={styles.card}>
      ...
      <form onSubmit={handleSubmit(onSubmit)} noValidate>
        ...
        />
        <Input
          name="email" icon="email" type="email"
        ...
        />
        <Input
          name="confirmPassword" icon="lock" type="password"
      ...
      <Button variant="google" onClick={() => window.location.href = "/api/auth/google"}>
...
const styles = {
  ...
  divider: {
    ...
    margin: "18px 0", fontSize: 12,
    color: "rgba(255,255,255,0.35)",
  },
  switchLine: {
    textAlign: "center", fontSize: 13,
    color: "rgba(255,255,255,0.45)", marginTop: 20,
  },
